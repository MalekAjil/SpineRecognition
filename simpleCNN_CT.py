...
x = tf.compat.v1.placeholder(tf.float32, shape=[None, width * height * depth])  # [None, 28*28]
y_ = tf.compat.v1.placeholder(tf.float32, shape=[None, nLabel])  # [None, 10]
...
testset = input_3Dimage.get_data_MRI(sess, 'test', 30)
